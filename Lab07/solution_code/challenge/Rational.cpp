...
public:
    ...
    /*
     * Reduce the fraction by diving by GCD to make sure that
     * the fraction is stored in the reduced form.
     */
    void reduce() {
    ...
    Rational operator-(const Rational &a) const {
        Rational r;
        r.numerator = a.denominator * numerator - a.numerator * denominator;
        r.denominator = a.denominator * denominator;
        r.reduce();
        return r;
    }
